...
<footer class="page-footer">
    ...
    <svg width="0" height="0">
        <defs>
          <clipPath id="myClip">
            <path d="M680.452 1H-2.5V242.5V385.5H718H1439V42H738.048C735.753 42 733.527 41.2103 731.745 39.7635L686.755 3.23651C684.973 1.78969 682.747 1 680.452 1Z" stroke="black"/>
          </clipPath>
        </defs>
      </svg>
</footer>
